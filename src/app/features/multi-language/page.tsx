...
function RealWorldUseCase() {
  ...
  return (
    <section className="container mx-auto bg-gradient-to-b from-transparent to-slate-900/50 px-4 py-16 md:py-24">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
...
function CustomerTestimonial() {
  return (
    <section className="container mx-auto px-4 py-16 md:py-24">
      ...
      >
        <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-cyan-500">
          <Star className="h-8 w-8 text-white" />
        </div>
        <blockquote className="mb-6 text-xl text-white italic md:text-2xl">
          &quot;Meedo&apos;s multilingual AI has been a game-changer. We&apos;ve
          expanded into three new European markets, and customer satisfaction
          scores in those regions are now on par with our domestic market. We
          didn&apos;t need to hire a single translator.&quot;
        </blockquote>
        ...
        <div className="mt-6 flex justify-center">
          <div className="flex h-12 w-32 items-center justify-center rounded-lg border border-white/10 bg-slate-700/50 text-sm text-slate-500">
  ...
  return (
    <section className="container mx-auto px-4 py-8">
      <div className="text-center">
        ...
        <p className="sr-only text-xs text-slate-600">Keywords:</p>
